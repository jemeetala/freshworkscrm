import Axios from "axios";
  ...
  defaultAxios.interceptors.response.use(
    ...
    export const getTasks =({data={},headers={},params={}, path = {}}={})=>{ return defaultAxios({
